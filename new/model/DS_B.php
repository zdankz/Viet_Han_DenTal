...
$query = " SELECT DISTINCT profile.MaUser, profile.Ten, profile.avatar FROM epxs LEFT JOIN users ON users.MaUSer = epxs.MaUser LEFT JOIN profile ON profile.MaUser = users.MaUser LEFT JOIN bophan ON bophan.MaBP = epxs.MaBP LEFT JOIN dichvu ON dichvu.MaDV = epxs.MaDV where bophan.TenBP = 'B'";
